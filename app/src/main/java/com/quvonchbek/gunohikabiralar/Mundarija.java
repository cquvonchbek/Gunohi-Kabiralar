...
public class Mundarija extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Mundarija");

        try {
            JSONObject obj = new JSONObject((String) Objects.requireNonNull(json_string()));
            JSONArray sahifalar = obj.getJSONArray("lotin");
        ...
        kabiralar.setOnItemClickListener((_param1, _param2, _param3, _param4) -> {
            ...
            try {
                ...
                JSONArray sahifalar = obj.getJSONArray("lotin");
                web.loadUrl("file:///android_asset/Kaboir/".concat(sp).concat("/").concat(String.valueOf((long) (_param3)).concat("_l_").concat("gunohi_kabira.html")));
